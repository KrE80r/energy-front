...
def generate_cache_busters():
    ...
    # Define assets to cache-bust (relative to root)
    assets = [
        "css/style.css",
        "js/app.js",
        "js/calculator.js",
    ...
    for asset in assets:
        if os.path.exists(asset):
            ...
            # Use the asset path as the key (no 'docs/' prefix)
            key = asset
    ...
    # Write cache-busters to JSON file at root
    output_path = "cache-busters.json"
